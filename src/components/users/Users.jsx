...
import {
  add_user, show_user, update_user, delete_user, show_all_users,
} from '../../actions/actions_users';
import './Users.scss';
// import actions frm constants
// import {
//   ADD_USER, SHOW_USER, UPDATE_USER, DELETE_USER, SHOW_USERS,
// } from '../../actions/actions_users';
...
function Users() {
  ...
  // to store all form data before submission
    ...
    <>
      ...
      <div className="row-div">
        <div className="col-div">
          <span className="test-span">Test Data</span>
        </div>
      </div>
    </>
  );
